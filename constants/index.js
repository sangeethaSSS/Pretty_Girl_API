...
module.exports = { 
  ...
  userMessage: {
    ...
    MACHINE_DUPLICATION: 'Machine No. already exits',
    DESIGN_DUPLICATION: 'Design No. already exits',
    DEPARTMENT_DUPLICATE: 'Department already exits',
    ITEMGROUP_DUPLICATION: 'Itemgroup already exits',
    SHORTNAME_DUPLICATION: 'Shortname already exits',
    CUSTOMER_DUPLICATION: 'Customer already exits',
    ITEM_DUPLICATION: 'Item already exits',
    COLOR_DUPLICATION: 'Color already exits',
    DESIGNATION_DUPLICATION: 'Designation already exits',
